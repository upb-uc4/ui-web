...
describe("Proposal Validation Tests", () => {
    ...
    test.skip("Test Matriculation Proposal Validation addMatriculation", async () => {
    ...
    test.skip("Test Matriculation Proposal Validation updateMatriculationData", async () => {
    ...
    test.skip("Test Matriculation Proposal Validation addEntriesToMatriculationData", async () => {
    ...
    test.skip("Test Admission Proposal Validation addCourseAdmission", async () => {
    ...
    test.skip("Test Admission Proposal Validation dropCourseAdmission", async () => {
