                ...
                <div class="lg:flex">
                    ...
                    <div class="w-full lg:w-2/3">
                        <div class="mb-4 flex">
                            ...
                            <p v-if="hasError('role')" class="text-red-600 ml-1 mt-1">
                                {{ showError("role") }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="w-full lg:w-2/3">
                        <div class="mb-4 flex flex-col">
                            ...
                            <input
                                ...
                                :disabled="editMode"
                            />
                            <p v-if="hasError('username')" class="text-red-600 ml-1 mt-1">
                                {{ showError("username") }}
                            </p>
                        </div>
                        <div class="mb-4 flex flex-col">
                            ...
                            />
                            <p v-if="hasError('email')" class="text-red-600 ml-1 mt-1">
                                {{ showError("email") }}
                            </p>
                        </div>
                        <div v-if="!editMode" class="mb-4 flex flex-col">
                            ...
                            />
                            <p v-if="hasError('password')" class="text-red-600 ml-1 mt-1">
                                {{ showError("password") }}
                            </p>
                        </div>
                    </div>
                ...
                <div class="lg:flex">
                    ...
                    <div class="w-full lg:w-2/3">
                        <div class="mb-4 flex flex-col">
                            ...
                            <div class="flex flex-row">
                                <div class="w-full pr-2 flex-col">
                                    ...
                                    />
                                    <p v-if="hasError('firstName')" class="text-red-600 ml-1 mt-1">
                                        {{ showError("firstName") }}
                                    </p>
                                </div>
                                <div class="w-full pl-2 flex-col">
                                    ...
                                    />
                                    <p v-if="hasError('lastName')" class="text-red-600 ml-1 mt-1">
                                        {{ showError("lastName") }}
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="mb-4 flex flex-col">
                            ...
                            <p v-if="hasError('birthdate')" class="text-red-600 ml-1 mt-1">
                                {{ showError("birthdate") }}
                            </p>
                            <div class="flex flex-row">
                                <div class="w-full pr-2 flex-col">
                        ...
                        <div class="mb-4 flex flex-col">
                            ...
                            <p v-if="hasError('address')" class="text-red-600 ml-1 mt-1">
                                {{ showError("address") }}
                            </p>
                            <div class="w-full flex flex-col">
                                ...
                                <p v-if="hasError('country')" class="text-red-600 ml-1 mt-1">
                                    {{ showError("country") }}
                                </p>
                            </div>
                            <div class="flex flex-row">
                                <div class="w-full pr-2 mb-4 flex flex-col">
                                    ...
                                    <input
                                        ...
                                        placeholder="Street"
                                    />
                                    <p v-if="hasError('street')" class="text-red-600 ml-1 mt-1">
                                        {{ showError("street") }}
                                    </p>
                                </div>
                                <div class="pl-2 flex flex-col">
                                    ...
                                    <input
                                        ...
                                        placeholder="Number"
                                    />
                                    <p v-if="hasError('houseNumber')" class="text-red-600 ml-1 mt-1">
                            ...
                            <div class="flex flex-row">
                                <div class="pr-2 flex flex-col">
                                    ...
                                    />
                                    <p v-if="hasError('zipCode')" class="text-red-600 ml-1 mt-1">
                                        {{ showError("zipCode") }}
                                    </p>
                                </div>
                                <div class="w-full pl-2 flex flex-col">
                                    ...
                                    <input
                                        ...
                                        placeholder="City"
                                    />
                                    <p v-if="hasError('city')" class="text-red-600 ml-1 mt-1">
                                        {{ showError("city") }}
                                    </p>
                                </div>
                            </div>
                ...
                <div class="lg:flex">
                    ...
                    <div class="w-full lg:w-2/3 flex flex-col">
                        ...
                        <div class="mb-4 flex flex-col">
                            ...
                            <p v-if="hasError('freeText')" class="text-red-600 ml-1 mt-1">
                                {{ showError("freeText") }}
                            </p>
                        </div>
                        <div class="mb-4 flex flex-col">
                        ...
                        <div class="mb-4 flex flex-col">
                            ...
                            <div class="flex flex-row">
                                <div class="w-1/2 flex flex-col">
                                    ...
                                    />
                                    <p v-if="hasError('immatriculationStatus')" class="text-red-600 ml-1 mt-1">
                                ...
                                <div class="w-1/4 flex flex-col pl-2">
                                    ...
                                    />
                                    <p v-if="hasError('matriculationId')" class="text-red-600 ml-1 mt-1">
                        ...
                        <div class="mb-4 mt-8 flex flex-col">
                            ...
                            <div class="flex flex-row">
                                <div class="w-1/2 flex flex-col">
                                    ...
                                    />
                                    <p v-if="hasError('fieldsOfStudy')" class="text-red-600 ml-1 mt-1">
                                ...
                                <div class="w-1/4 pl-2 flex flex-col">
                                    ...
                                    />
                                    <p v-if="hasError('semesterCount')" class="text-red-600 ml-1 mt-1">
