    ...
    <div class="w-full lg:mt-20 mt-8 bg-gray-300 mx-auto h-screen">
        ...
        <div>
            <section class="border-t-2 py-8 border-gray-400">
                <div class="lg:flex">
                    <div
                        class="w-full lg:w-1/3 lg:block mr-12 flex flex-col mb-4"
                    >
                        <label
                        ...
                        <div class="mb-4 flex">
                            ...
                            >
                                <label class="flex items-center">
                                    ...
                                    />
                                    <span
                                        class="ml-2 text-gray-700 text-md font-medium"
                                        >{{ role }}</span
                                    >
                                </label>
                            </div>
                ...
                <div class="lg:flex">
                    ...
                    <div class="w-full lg:w-2/3">
                        <div class="mb-4 flex flex-col">
                            <label
                                class="text-gray-700 text-md font-medium mb-3"
                                >Username</label
                            >
                            <input
                                type="text"
                    ...
                    <div class="w-full lg:w-2/3">
                        ...
                        <div class="mb-4 flex flex-col">
                            ...
                            <div class="w-full flex flex-col">
                                ...
                                >
                                <select
                                    class="w-1/2 py-3 mb-4 rounded-lg border-gray-400 text-gray-600 form-select"
                                    name="country"
                                    id="country"
            ...
            <section class="border-t-2 py-8 border-gray-400" v-if="isLecturer">
                <div class="lg:flex">
                    ...
                    <div class="w-full lg:w-2/3 flex flex-col">
                        ...
                        <div class="mb-4 flex flex-col">
                            <label
                                class="text-gray-700 text-sm font-medium mb-3"
                                >Free Text Description (optional)</label
                            >
                            <textarea
                                name="description"
                                id="description"
                        ...
                        <div class="mb-4 flex flex-col">
                            <label
                                class="text-gray-700 text-sm font-medium mb-3"
                                >Fields of Research (optional)</label
                            >
                            <textarea
                                name="researchField"
                                id="researchField"
...
>
                        ...
                        <div class="mb-4 flex flex-col">
                            ...
                            <div class="flex flex-row">
                                <div class="w-1/2 flex flex-col">
                                    ...
                                    />
                                    <p
                                        v-if="hasError('immatriculationStatus')"
                                        class="text-red-600 ml-1 mt-1"
                                    >
                                ...
                                <div class="w-1/4 flex flex-col pl-2">
                                    ...
                                    />
                                    <p
                                        v-if="hasError('matriculationId')"
                                        class="text-red-600 ml-1 mt-1"
                                    >
                                        {{ showError("matriculationId") }}
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="mb-4 mt-8 flex flex-col">
                            ...
                            <div class="flex flex-row">
                                <div class="w-1/2 flex flex-col">
                                    ...
                                    >
                                    <multi-select
                                        :inputList="fieldsOfStudy"
                                        :preSelection="
                                            account.student.fieldsOfStudy
                                        "
                                        placeholder="Select a Field of Study"
                                        v-on:changed="updateFieldsOfStudy"
                                    />
                                    <p
                                        v-if="hasError('fieldsOfStudy')"
                                        class="text-red-600 ml-1 mt-1"
                                    >
                                        {{ showError("fieldsOfStudy") }}
                                    </p>
                                </div>
                                <div class="w-1/4 pl-2 flex flex-col">
                                    ...
                                    />
                                    <p
                                        v-if="hasError('semesterCount')"
                                        class="text-red-600 ml-1 mt-1"
                                    >
                                        {{ showError("semesterCount") }}
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <section
                class="border-t-2 py-8 border-gray-400"
                :hidden="!editMode"
            >
                <div class="lg:flex">
                    <div
            ...
            <section class="border-t-2 py-8 border-gray-400 lg:mt-8">
                <div class="hidden sm:flex justify-between">
                    ...
                    <div class="flex justify-end items-center">
                        <button
                            type="button"
                            @click="back"
                            class="w-32 mr-6 btn btn-blue-secondary"
                        >
                            Cancel
                        </button>
                        <button
                ...
                <div class="sm:hidden">
                    <button
                        type="button"
                        @click="back"
                        class="mb-4 w-full btn btn-blue-secondary"
                    >
                        Cancel
                    </button>
                    <button
                    ...
                    <button
                        @click="confirmDeleteAccount"
                        class="w-full btn btn-red-secondary"
                    >
                        Delete
                    </button>
                </div>
...
<script lang="ts">
    ...
    export default {
        ...
        setup(props) {
            ...
            let fieldsOfStudy = Object.values(FieldOfStudy).filter(
                (e) => e != FieldOfStudy.NONE
            )
            let countries = Object.values(Country).filter(
                (e) => e != Country.NONE
            )
            ...
            async function loadAccount() {
                ...
                const response = await userManagement.getSpecificUser(
                ...
                if (response.statusCode !== 200) {
                    ...
                    account.user = result
                    initialAccount.user = JSON.parse(
                    ...
                    if (result.role == Role.LECTURER) {
                        ...
                        initialAccount.lecturer = JSON.parse(
                            JSON.stringify(account.lecturer)
                        )
                    } else if (result.role == Role.STUDENT) {
                        account.student = result as Student
                        account.student.fieldsOfStudy[
                            account.student.fieldsOfStudy.length
                        ] = FieldOfStudy.NONE
                        initialAccount.student = JSON.parse(
                            JSON.stringify(account.student)
                        )
                    } else if (result.role == Role.ADMIN) {
                        account.admin = result as Admin
                        initialAccount.admin = JSON.parse(
                            JSON.stringify(account.admin)
                        )
                    }
                }
            }
            ...
            function updateFieldsOfStudy(value: any) {
                account.student.fieldsOfStudy = value.value.filter(
                    (f: String) => f != FieldOfStudy.NONE
                )
            }
            ...
            let hasInput = computed(() => {
                if (
                    ...
                    account.user.address.country !=
                        initialAccount.user.address.country ||
                    account.user.address.street !=
                        initialAccount.user.address.street ||
                    account.user.address.houseNumber !=
                        initialAccount.user.address.houseNumber ||
                    account.user.address.zipCode !=
                        initialAccount.user.address.zipCode ||
                    account.user.address.city !=
                        initialAccount.user.address.city ||
                    account.user.picture != initialAccount.user.picture ||
                    //lecturer properties
                    account.lecturer.freeText !=
                        initialAccount.lecturer.freeText ||
                    account.lecturer.researchArea !=
                        initialAccount.lecturer.researchArea ||
                    //student properties
                    account.student.immatriculationStatus !=
                        initialAccount.student.immatriculationStatus ||
                    account.student.matriculationId !=
                        initialAccount.student.matriculationId ||
                    account.student.semesterCount !=
                        initialAccount.student.semesterCount
                ) {
                    return true
                }
                ...
                switch (account.user.role) {
                    ...
                    case Role.STUDENT: {
                        ...
                        if ("fieldsOfStudy" in newUser) {
                            newUser.fieldsOfStudy = newUser.fieldsOfStudy.filter(
                                (field) => field != FieldOfStudy.NONE
                            )
                        }
                        break
                    }
            ...
            async function deleteAccount() {
                ...
                const genericResponseHandler = new GenericResponseHandler()
                const response = await userManagement.deleteUser(
                    account.user.username
                )
                const result = genericResponseHandler.handleReponse(response)
