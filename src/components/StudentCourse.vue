    ...
    <div class="flex shadow-xl">
            ...
            <div class="flex">
                <div class="w-full">
                    <div class="flex items-baseline">
                        ...
                        <div class="ml-4 text-gray-600 text-xs uppercase font-semibold tracking-wide">
                            <i class="inline fas fa-users text-lg" />
                            {{ course.currentParticipants }} / {{ course.maxStudents }}
                        </div>
                    </div>
                    <div class="mt-2 font-semibold text-2xl leading-tight truncate text-gray-900">
                        {{ course.courseName }}
                    </div>
                    <div class="mt-1 font-semibold text-sm text-gray-600">
                        {{ course.lecturerId }}
                    </div>
        ...
        <div class="w-1/6 bg-white rounded-lg rounded-l-none pl-4 pr-8">
            <div class="mt-6 flex h-full items-center justify-center">
                ...
                <p
                    v-else
                    class="flex text-red-600 text-opacity-50 text-center py-2 px-8 rounded-lg font-semibold"
                >
                    Course is full
                </p> 
            </div>
