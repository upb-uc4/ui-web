<template>
    <base-menu>
        <template #hook>Exam Regulations</template>
        <template #content>
            <div>
                ...
                <div class="absolute left-0 lg:w-64 mt-4 z-30 lg:z-10 bg-white shadow-md rounded-lg overflow-hidden border">
                    <menu-body />
                </div>
            </div>
        </template>
...
<script lang="ts">
    ...
    import MenuBody from "./ExRegMenuBody.vue";
