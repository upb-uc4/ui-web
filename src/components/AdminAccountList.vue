    ...
    <div class="w-full max-w-4xl">
            ...
            <div class="w-full flex flex-row pt-2 mb-8">
                <div class="w-full relative mx-auto text-gray-600 flex">
                    ...
                    <input
                        ...
                        placeholder="Filter"
                    />
                    <button class="-ml-8 mr-5 focus:outline-none" title="Refresh" @click="refresh">
        ...
        <div class="flex justify-center mt-16">
            <router-link to="/createAccount">
                <button title="Add a new User" class="px-4 btn btn-green-primary-500">New Account</button>
            </router-link>
        </div>
    </div>
</template>
