...
export class AddMatriculationDataTransaction extends AbstractTransaction {
    ...
    public buildTransactionInfo(): TransactionInfo {
        return AddMatriculationDataTransaction.buildTransactionInfo(this.matriculationData);
    }
