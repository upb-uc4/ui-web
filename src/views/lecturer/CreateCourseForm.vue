<template>
    <section class="w-full pt-5 px-20 py-20 flex items-center justify-center">
        <div class="w-full container items-center justify-center">
            <h2 class="p-10 text-4xl font-semibold text-gray-900 text-center">
                Create A New Course
            </h2>
            <div class="w-full flex justify-center items-center">
                ...
                >
                    ...
                    >
                        <h2
                            class="text-xl font-semibold text-red-500 text-center"
                        >
                            Please check your inputs!
                        </h2>
                        <p
                            class="text-m font-semibold text-red-500 text-center"
                        >
                            Errors in: {{ collectedErrors }}
                        </p>
                    </div>
                </div>
            </div>
