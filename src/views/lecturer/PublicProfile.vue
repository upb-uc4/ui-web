<template>
    ...
    <div
        class="p-12 border dark:bg-normalgray-900 dark:border-normalgray-700 rounded-md sm:space-y-8 space-y-4 text-sm text-gray-800 dark:text-gray-300"
    >
        <div class="sm:flex items-center sm:space-x-8 space-y-2">
            ...
            <div>
                ...
                <h2 class="text-xl text-gray-500">@{{ lecturer.username }}</h2>
            </div>
        </div>
        <div v-if="lecturer.isActive" class="space-y-4">
            <div>
                <div class="flex justify-between">
                    <div class="font-medium text-lg">Research Area</div>
                </div>
        ...
        <div class="space-y-2">
            ...
            <div>
                <div v-if="lecturer.isActive" class="flex items-center space-x-2">
                    <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path
                            stroke-linecap="round"
                            stroke-linejoin="round"
    ...
    export default {
        ...
        setup(props: any) {
            ...
            const title = computed(() => {
                if (props.lecturer.lastName.slice(-1) === "s") {
            ...
            return { profilePicture, title, name };
        },
    };
</script>
