                    ...
                    <div class="w-full lg:w-2/3">
                        <div class="lg:flex mb-6">
                            <div class="lg:w-1/2 mb-6 lg:mb-0 flex flex-col lg:mr-16">
                                ...
                                <input type="text" class="w-full border-2 border-gray-400 rounded-lg py-3 text-gray-600 form-input">
                            </div>
                        ...
                        <div class="lg:w-1/2 mb-6 flex flex-col lg:pr-8">
                            <label for="dob" class="text-gray-700 text-md font-medium mb-3">Date of Birth</label>
                            <input type="text" id="dob" class="w-full border-2 border-gray-400 rounded-lg py-3 text-gray-600 form-input">
                        </div>
                    </div>
